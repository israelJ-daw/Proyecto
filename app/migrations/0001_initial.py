# Generated by Django 5.1.13 on 2026-01-15 20:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.PositiveSmallIntegerField(choices=[(1, 'Administrador'), (2, 'Usuario')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tareas', to='app.categoria')),
                ('proyecto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tareas', to='app.proyecto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_vencimiento', models.DateField(blank=True, null=True)),
                ('tarea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subtareas', to='app.tarea')),
            ],
        ),
    ]
